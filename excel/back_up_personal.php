...
header("Content-Disposition: attachmen;filename=".$_GET['dni']."_".$_GET["inicio"]."_al_".$_GET["fin"].".xls");
...
<table>
    ...
    <tr>
        <td>DEPENDENCIA</td>
        <td><?php echo utf8_decode($personal[0]["dependencia"]); ?></td>        
    </tr>
    <tr>
        <td>PUESTO</td>
        <td><?php echo utf8_decode($personal[0]["puesto"]); ?></td>
    </tr>
</table>
<table>
