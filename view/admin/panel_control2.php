...
<section class="content">
            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="horas_trabajo">
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                <button class="btn btn-sm btn-outlined btn-primary">Cerrar Jornada</button>
                            </div>
    ...
    <script>
        ...
        function cargar_datos_nueva_tabla(){
            $("#tbody_nuevo_panel").html('<tr><td colspan="7"><div class="spinner-border" role="status"><span class="sr-only">Loading...</span></div></td></tr>');
            // // const response = await fetch("./ajax/panel_control/nuevo_reporte_asistencia.php",{
            // //     method:'POST',
            // //     body: JSON.stringify({"fec_asi":$("#marc_sel_fecha").val()})
            // // })
            ...
            // // const xd = await data
            // // $("#tbody_nuevo_panel").html(xd.html)
            // try {
            //     const response = await fetchWithTimeout('./ajax/panel_control/nuevo_reporte_asistencia.php', {
            //         method:"POST",
            //         body: JSON.stringify({"fec_asi":$("#marc_sel_fecha").val()}),
            //         timeout: 10000
            //     });
